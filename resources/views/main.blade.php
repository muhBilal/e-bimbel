...
<head>
    ...
    <title>@yield('title') My-Bimble </title>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=""> Bimble</a>
                        ...
                        <div class="dropdown for-notification">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                ...
                                <a class="dropdown-item media bg-flat-color-1" href="#">
                                    ...
                                    <p>Server #1 Youre the best.</p>
                                </a>
                                <a class="dropdown-item media bg-flat-color-2" href="#">
                                    <i class="fa fa-check"></i>
                                    <p>Server #2 Youre the best.</p>
                                </a>
                                <a class="dropdown-item media bg-flat-color-5" href="#">
                                    <i class="fa fa-info"></i>
                                    <p>Hi Muhammad Bilal.</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{ asset('style/images/bilal.jpg') }}">
                        </a>
